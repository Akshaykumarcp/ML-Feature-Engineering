...
- Censoring, or capping, means capping the maximum or minimum of a distribution at an arbitrary value.
...
- The numbers at which to cap the distribution can be determined:
        - arbitrarily
        - using the inter-quantal range proximity rule (0.7.2 section of the series)
