...
In this example, we will discuss MinMaxScaling.

=================================================================

Scaling to Minimum and Maximum values - MinMaxScaling
- Minimum and maximum scaling squeezes the values between 0 and 1. 
- It subtracts the minimum value from all the observations, and then divides it by the value range:
...
- The shape of a min-max scaled distribution will be similar to the original variable, but the variance may change, 
        so not identical. 
- This scaling technique is also sensitive to outliers.

- This technique will not normalize the distribution of the data thus if this is the desired outcome, 
        we should implement any of the techniques discussed in section 0.5.
...
- Note for this example, how the minimum and maximum values are are quite different in the different variables.

- When performing min-max scaling on the data set, we need to first identify the minimum and maximum values of the 
        variables. 
...
""" 
MinMaxScaling
- The MinMaxScaler from scikit-learn subtracts the minimum value and re-scales the the value range, 
        rendering the variable values between 0 and 1.
 """
...
- As expected, the minimum and maximum values for all the variables are 0 and 1, respectively. 
- The mean is not centered at zero, and the variance changes.
 """
